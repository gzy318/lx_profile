/**
 * LX Profile - V28.0 (Visual Upgrade & Status Enhanced)
 * 1. 修复：Telegram 图标显示问题。
 * 2. 美化：Email 按钮升级为渐变胶囊样式。
 * 3. 增强：后台增加 5 种状态选项，前台头像光圈颜色随状态改变。
 * 4. 重构：后台 UI 彻底翻新，采用"极光深色"风格 (0 CDN)。
 */
