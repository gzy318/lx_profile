...
app.get('/', async (c) => {
  ...
  <div class="header">
    <div class="status-bar"><span id="clock">00:00:00</span><span style="opacity:0.2">|</span><span>📍 ${c.req.raw.cf?.city || 'China'}</span></div>
